 ...
 * Description : Implémentation de Fee
 */

#include "Fee.h"
#include <iostream>

Fee::Fee(const std::string& name, int hp, const Attack& attack)
    : Pokemon(name, hp, attack) { types = { Type::Fee }; }

void Fee::attaquer(Pokemon& cible) {
    double mult=1.0;
...
Pokemon* Fee::clone() const { return new Fee(*this); }
