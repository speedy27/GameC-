/*
 * Fichier : Electrik.cpp
 * Auteurs : Florian & Adrien
 * Description : Implémentation de Electrik
 */

#include "Electrik.h"
#include <iostream>

Electrik::Electrik(const std::string& name, int hp, const Attack& attack)
    : Pokemon(name, hp, attack) { types = { Type::Electrik }; }

void Electrik::attaquer(Pokemon& cible) {
    double mult=1.0;
...
Pokemon* Electrik::clone() const { return new Electrik(*this); }
