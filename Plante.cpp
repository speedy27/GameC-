 ...
 * Description : Implémentation de Plante
 */

#include "Plante.h"
#include <iostream>

Plante::Plante(const std::string& name, int hp, const Attack& attack)
    : Pokemon(name, hp, attack) { types = { Type::Plante }; }
...
Pokemon* Plante::clone() const { return new Plante(*this); }
