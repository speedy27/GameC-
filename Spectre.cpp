 ...
 * Description : Implémentation de Spectre
 */

#include "Spectre.h"
#include <iostream>

Spectre::Spectre(const std::string& name, int hp, const Attack& attack)
    : Pokemon(name, hp, attack) { types = { Type::Spectre }; }

void Spectre::attaquer(Pokemon& cible) {
    double mult=1.0;
...
Pokemon* Spectre::clone() const { return new Spectre(*this); }
