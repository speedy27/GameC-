 ...
 * Description : Implémentation de Feu
 */

#include "Feu.h"
#include <iostream>

Feu::Feu(const std::string& name, int hp, const Attack& attack)
    : Pokemon(name, hp, attack) { types = { Type::Feu }; }
...
Pokemon* Feu::clone() const { return new Feu(*this); }
